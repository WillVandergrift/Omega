...
if (empty($buildings))
{
    return searchDevicesByNameCount($name, $rowsPerPage);
}

//If the Rooms list is empty, search by name and building
if (empty($rooms))
{
    return searchDevicesByNameBuildingCount($name, $buildings, $rowsPerPage);
}

//Search by name, building, and room
return searchDevicesByNameRoomCount($name, $rooms, $rowsPerPage);